...
const details = {
    id: 6,
    title: "SIA Top-Up Refresher Training for Security Guards",
    description:"Renew your SIA Security Guarding licence, with our one-day SIA Top-Up Refresher Training for Security Guards. Book now to take advantage of unlimited resits, quicker certification, and free mock exams.",
    coursses : 10,
    coursemoney:89.99,
    offermoney : "£109.99",
    offerpercent : "18",
    imgurl:"https://res.cloudinary.com/dov0rmq5b/image/upload/v1739863492/Screenshot_2025-02-18_125433_iolxze.png",
} 
class TopUpSecurityGuards extends Component{
...
export default TopUpSecurityGuards