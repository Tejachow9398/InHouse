...
const details = {
    id : 5,
    title: "SIA Top-Up Refresher Training for Door Supervisors",
    description:"To renew your SIA Door Supervisor licence, you'll need to complete the new two-day SIA Top-Up Refresher Course for Door Supervisors. Book now to take advantage of unlimited resits, quicker certification, and free mock exams.",
    coursses : 14,
    coursemoney:99.99,
    offermoney : "£129.99",
    offerpercent : "23",
    imgurl:"https://res.cloudinary.com/dov0rmq5b/image/upload/v1739857074/Screenshot_2025-02-18_110631_yhn4ls.png",
}
class TopUpDoorSupervisors extends Component {
...
export default TopUpDoorSupervisors