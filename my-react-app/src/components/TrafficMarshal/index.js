...
const details = {
    ...
    description:"This Traffic Banksman (Marshal) training course is ideal for anyone looking to apply for a job that involves navigation of vehicles on site",
    coursses : 5,
    coursemoney:29.99,
    offermoney : "£69.99",
    offerpercent : "57",
    imgurl:"https://res.cloudinary.com/dov0rmq5b/image/upload/v1739865120/Screenshot_2025-02-18_132146_oeonad.png",
} 

class TrafficMarshal extends Component{
