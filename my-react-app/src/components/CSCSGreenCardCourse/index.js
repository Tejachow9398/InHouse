...
const details = {
    id : 11,
    title: "CSCS Green Card Course for Labourers",
    description:"Start your career in the construction industry by taking the first step: enrol in a CSCS Green Card course today. You can choose between a flexible, self-paced online option you can complete from home or a traditional in-person classroom course.",
    coursses : 8,
    coursemoney:89.99,
    offermoney : "£100.99",
    offerpercent : "18",
    imgurl:"https://res.cloudinary.com/dov0rmq5b/image/upload/v1739864629/Screenshot_2025-02-18_131334_mttfyr.png",
} 

class CSCSGreenCardCourse extends Component{
...
export default CSCSGreenCardCourse